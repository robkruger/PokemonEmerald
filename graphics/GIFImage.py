...
class GIFImage(object):
    def __init__(self, filename, window_size: tuple):
    ...
    def get_frames(self, window_size):
        image = self.image
        ...
        try:
            while 1:
                ...
                pi2 = pygame.transform.scale(pi2,
                                             (int((window_size[0] / 240) * pi2.get_rect().size[0]),
                                              int((window_size[1] / 160) * pi2.get_rect().size[1])))
